...
//            b.pos(tx2, ty2, 0.0).color(1.0f, 0.25f, 0.0625f, 1.0f).endVertex();
    ...
    public static void drawTexturedModalRect(int x, int y, double zLevel, double minU, double minV, double maxU, double maxV, int widthIn, int heightIn) {
        ...
        BufferBuilder.pos((double) (x + 0), (double) (y + heightIn), zLevel).tex(minU, maxV).endVertex();
        BufferBuilder.pos((double) (x + widthIn), (double) (y + heightIn), zLevel).tex(maxU, maxV).endVertex();
        BufferBuilder.pos((double) (x + widthIn), (double) (y + 0), zLevel).tex(maxU, minV).endVertex();
        BufferBuilder.pos((double) (x + 0), (double) (y + 0), zLevel).tex(minU, minV).endVertex();
        tessellator.draw();
    }
    ...
    public static void drawColorRectBatched(BufferBuilder BufferBuilder, double x, double y, double zLevel, double widthIn, double heightIn,
        ...
        BufferBuilder.pos(x + 0, y + heightIn, zLevel).color(r1, g1, b1, a1).endVertex();
        BufferBuilder.pos(x + widthIn, y + heightIn, zLevel).color(r2, g2, b2, a2).endVertex();
        BufferBuilder.pos(x + widthIn, y + 0, zLevel).color(r3, g3, b3, a3).endVertex();
        BufferBuilder.pos(x + 0, y + 0, zLevel).color(r4, g4, b4, a4).endVertex();
    }
